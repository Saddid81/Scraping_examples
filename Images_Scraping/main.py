...
def search_and_download(search_term: str, driver_path: str, target_path='./images', number_images=10):
    ...
    #target_folder = target_path +"/" ('_'.join(search_term.lower().split(' '))) # this does the same that does the previous line. But this only works for Linux users, instead the previous one is for all users
